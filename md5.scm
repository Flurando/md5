...
(define-module (md5)
  #:export (md5sum test-suite))

;;module-required (rnrs bytevectors)
;;usage -> {bytevector-u8-list bytevector-length bytevector->uint-list bytevector-u8-set! bytevector-copy! bytevector-u32-set! string->utf8} <in> {pad listify md5sum}
;;
